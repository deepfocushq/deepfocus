export default function Hero({
  ...
  return (
    <section id="top" className="relative overflow-hidden px-4 pt-40 pb-24 sm:pt-48 sm:pb-32">
      <div className="pointer-events-none absolute left-8 top-1/2 hidden -translate-y-1/2 -rotate-6 rounded-2xl border border-border bg-surface p-3 shadow-2xl xl:block xl:left-16">
        <div className="h-28 w-24 rounded-lg bg-gradient-to-br from-accent/30 to-accent-blue/30" />
      </div>
      <div className="pointer-events-none absolute right-8 top-1/2 hidden -translate-y-1/2 rotate-6 rounded-2xl border border-border bg-surface p-3 shadow-2xl xl:block xl:right-16">
